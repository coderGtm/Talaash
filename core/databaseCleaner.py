...
def cleanDatabaseOfUnreachablePages():
    ...
    Urls.objects.filter(title__contains = "404 Not Found").delete()
    Urls.objects.filter(title__contains = "500 Internal Server Error").delete()
    Urls.objects.filter(title__contains = "403 Forbidden").delete()
    Urls.objects.filter(title__contains = "400 Bad Request").delete()
    Urls.objects.filter(title__contains = "401 Unauthorized").delete()
    Urls.objects.filter(title__contains = "408 Request Timeout").delete()
    Urls.objects.filter(title__contains = "502 Bad Gateway").delete()
    Urls.objects.filter(title__contains = "504 Gateway Timeout").delete()
    Urls.objects.filter(title__contains = "503 Service Unavailable").delete()
    Urls.objects.filter(title__contains = "505 HTTP Version Not Supported").delete()
    Urls.objects.filter(title__contains = "410 Gone").delete()
    Urls.objects.filter(title__contains = "411 Length Required").delete()
    Urls.objects.filter(title__contains = "412 Precondition Failed").delete()
    Urls.objects.filter(title__contains = "413 Request Entity Too Large").delete()
    Urls.objects.filter(title__contains = "414 Request-URI Too Long").delete()
    Urls.objects.filter(title__contains = "415 Unsupported Media Type").delete()
    Urls.objects.filter(title__contains = "416 Requested Range Not Satisfiable").delete()
    Urls.objects.filter(title__contains = "417 Expectation Failed").delete()
    Urls.objects.filter(title__contains = "418 I'm a teapot").delete()
    Urls.objects.filter(title__contains = "421 Misdirected Request").delete()
    Urls.objects.filter(title__contains = "422 Unprocessable Entity").delete()
    Urls.objects.filter(title__contains = "423 Locked").delete()
    Urls.objects.filter(title__contains = "424 Failed Dependency").delete()
    Urls.objects.filter(title__contains = "426 Upgrade Required").delete()
    Urls.objects.filter(title__contains = "428 Precondition Required").delete()
    Urls.objects.filter(title__contains = "429 Too Many Requests").delete()
    Urls.objects.filter(title__contains = "431 Request Header Fields Too Large").delete()
    Urls.objects.filter(title__contains = "451 Unavailable For Legal Reasons").delete()
    Urls.objects.filter(title__contains = "444 No Response").delete()
    Urls.objects.filter(title__contains = "449 Retry With").delete()
    Urls.objects.filter(title__contains = "450 Blocked by Windows Parental Controls").delete()
    Urls.objects.filter(title__contains = "451 Redirect").delete()
    Urls.objects.filter(title__contains = "494 Request Header Too Large").delete()
    Urls.objects.filter(title__contains = "495 Cert Error").delete()
    Urls.objects.filter(title__contains = "496 No Cert").delete()
    Urls.objects.filter(title__contains = "497 HTTP to HTTPS").delete()
    Urls.objects.filter(title__contains = "499 Client Closed Request").delete()
    Urls.objects.filter(title__contains = "499 Token expired/invalid").delete()
    Urls.objects.filter(title__contains = "499 SSL Certificate Error").delete()
    Urls.objects.filter(title__contains = "499 SSL Certificate Required").delete()
    Urls.objects.filter(title__contains = "499 HTTP Request Sent to HTTPS Port").delete()
